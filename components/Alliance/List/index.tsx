...
const List = () => {
    ...
    return (
        <Fragment>
            <div className="grid grid-cols-1 lg:grid-cols-2 justify-evenly my-5 sm:my-[90px] gap-[20px] sm:gap-[50px] px-4 md:px-[50px] xl:px-[150px]">
                {AlliancesList.map((alliance) => {
                    return (
                        <div
                            key={alliance.id}
                            className="flex items-center gap-4 bg-[#EAF2FF] px-6 py-4 rounded-full"
                        >
